...
* <p>
* TerrainPlane is also used to build the shape for the visualization object for a static terrain mesh physics object.
* <p>
* If a flat plane is desired, use Plane instead.<br>
