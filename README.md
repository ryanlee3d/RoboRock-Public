# 165 Final Robo-Rock
A final game project for CSUS 165 - Computer Game Architecture
Ryan & Nick
FPS Bullet Hell
...
- **Up Arrow / Gamepad Left Stick Up:** Move menu selection up
- **Down Arrow / Gamepad Left Stick Down:** Move menu selection down
- **Left Arrow / Gamepad Left Stick Left:** Change map selection left
- **Right Arrow / Gamepad Left Stick Right:** Change map selection right
- **Enter / Gamepad A Button:** Confirm menu option
...
- **Escape:** Pause game
- **Enter / Gamepad A Button:** Continue after death
...
- **Pistol Shoot Only:** https://freesound.org/people/bolkmar/sounds/455922/
